...
const Section2pt2 = () => {
  return (
    <div className='grid grid-cols-9 grid-rows-12 h-[900px]'>
      <div className='col-start-1 col-end-10 row-start-4 flex justify-around items-center'>
      <div className='w-[360px] h-[306px] cursor-pointer'><img src='/sofa5.svg' alt='sofa' /></div>
      <div className='w-[360px] h-[306px] cursor-pointer'><img src='/sofa6.svg' alt='sofa' /></div>
      <div className='w-[360px] h-[306px] cursor-pointer'><img src='/sofa7.svg' alt='sofa' /></div>
      </div>
      <div className='w-[399px] h-[42px] col-start-4 col-end-7 row-start-7 flex justify-center items-center text-[#151875] text-[42px] leading-[49.22px] '><div className={josefin1.className}>What Shopex Offer!</div></div>
      ...
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5'>
        ...
        <div className='row-start-4 row-end-5 flex justify-center items-center text-[#1A0B5B4D] text-opacity-[30%] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</div>
      </div>
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5'>
