...
const Section2pt2 = () => {
  return (
    <div className='grid grid-cols-9 grid-rows-12 h-[900px]'>
      ...
      <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px]'><img src='/sofa5.svg' loading="lazy"   alt='sofa' /></div>
      <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px]'><img src='/sofa6.svg' loading="lazy"  alt='sofa' /></div>
      <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px] smhidden'><img src='/sofa7.svg'  loading="lazy" alt='sofa' /></div>
      </div>
      ...
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5'>
        <div className='row-start-2 row-end-3 flex justify-center items-center'><img src='/truck.svg' loading="lazy"  alt='truck-kun' height={65} width={65}/></div>
      ...
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5'>
        <div className='row-start-2 row-end-3 flex justify-center items-center'><img src='/cashback.svg' loading="lazy"  alt='money' height={65} width={65}/></div>
        <div className='row-start-3 row-end-4 flex justify-center items-center text-[#151875] text-[22px]'><p className={josefin1.className}>24/7 Support</p></div>
        <div className='row-start-4 row-end-5 flex justify-center items-center text-[#1A0B5B4D] text-opacity-[30%] smhidden '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</div>
      </div>
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5'>
        <div className='row-start-2 row-end-3 flex justify-center items-center'><img src='/badge.svg' loading="lazy"  alt='honor' height={65} width={65}/></div>
        <div className='row-start-3 row-end-4 flex justify-center items-center text-[#151875] text-[22px]'><p className={josefin1.className}>24/7 Support</p></div>
        <div className='row-start-4 row-end-5 flex justify-center items-center text-[#1A0B5B4D] text-opacity-[30%] smhidden'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</div>
      </div>
      <div className='w-[270px] h-[320px]  shadow-md grid grid-cols-1 grid-rows-5 smhidden'>
        <div className='row-start-2 row-end-3 flex justify-center items-center'><img src='/24to7.svg' loading="lazy"  alt='all the time' height={65} width={65}/></div>
        <div className='row-start-3 row-end-4 flex justify-center items-center text-[#151875] text-[22px]'><p className={josefin1.className}>24/7 Support</p></div>
        <div className='row-start-4 row-end-5 flex justify-center items-center text-[#1A0B5B4D] text-opacity-[30%] smhidden'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</div>
      </div>
      </div>
