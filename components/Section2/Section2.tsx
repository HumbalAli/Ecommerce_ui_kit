...
<div className='row-start-2 row-end-6 col-start-1 col-end-10 flex items-center justify-evenly'>
    <div><img src='/pro1.svg' alt='prod1' className='w-[270px] h-[361px] cursor-pointer hover:w-[300px] '/></div>
    <div><img src='/pro2.svg' alt='prod2' className='w-[270px] h-[361px] cursor-pointer hover:w-[300px] '/></div>
...
<div className='text-[#1A0B5B] col-start-4 col-end-7 justify-center items-center flex w-[367px] h[42px] text-[42px] leading-[49.22px]'><p className={josefin1.className}>Leatest Products</p></div>
   <div className='col-end-4 col-start-7 justify-center flex items-center'>
    ...
    <div className='col-start-1 col-end-10 row-start-11 flex justify-around items-center gap-3'>
        <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px] smhidden'><img src='/sofa2.svg' alt='sofa'  /></div>
        <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px] '><img src='/sofa3.svg' alt='sofa' /></div>
        <div className='w-[360px] h-[306px] cursor-pointer hover:w-[400px] '><img src='/sofa4.svg' alt='sofa' /></div>
    </div>
    </div>
  )
}
