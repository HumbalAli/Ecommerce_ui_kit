...
<div className='col-start-5 row-start-4 col-end-9 justify-center items-center flex'>
    <div className={josefin1.className}><p className='text-[#151875] text-[35px] leading-[46.2px]'>Unique Features Of leatest &
...
<div className='flex justify-center items-center col-start-5 col-end-8 row-end-11 gap-2'>
