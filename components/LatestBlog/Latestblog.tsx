...
const Latestblog = () => {
  return (
    ...
    <div className='col-start-1 col-end-6 flex justify-around items-center text-[#151875] font-bold text-[42px] leading-[49.22px] smtext'>Latest Blog</div>
      ...
      <div className='col-start-1 col-end-6 row-start-2 row-end-2 justify-center items-center w-[370px] h-[255px]'><img src='/img1.svg' alt="img"/></div>
        <div className='flex justify-center items-center row-start-3 row-end-5 col-start-1 col-end-5 gap-[35px]'>
            <div className='flex items-center justify-center mdtext1'><div><img src='/pen.svg' alt="img" className='mdhidden smhidden'/></div><div className={josefin1.className}>SaberAli</div></div>
            <div className='flex items-center justify-center gap-[1px] mdtext1'><div><img src='/calendar.svg'  loading='lazy' alt="img" className='smhidden mdhidden'/></div><div className={josefin1.className}>21 August,2020</div></div>
        </div>
      ...
      <div className='col-start-1 col-end-6 row-start-2 row-end-2 justify-center items-center w-[370px] h-[255px]'><img src='/img2.svg' alt="img"  loading='lazy'/></div>
        <div className='flex justify-center items-center row-start-3 row-end-5 col-start-1 col-end-5 gap-[35px]'>
            <div className='flex items-center justify-center mdtext1'><div><img src='/pen.svg' className='mdhidden smhidden' alt="img"/></div><div className={josefin1.className}>SaberAli</div></div>
            <div className='flex items-center justify-center gap-[1px] mdtext1'><div><img src='/calendar.svg'  loading='lazy' alt="img" className='mdhidden smhidden'/></div><div className={josefin1.className}>21 August,2020</div></div>
        </div>
      ...
      <div className='col-start-1 col-end-6 row-start-2 row-end-2 justify-center items-center w-[370px] h-[255px]'><img src='/img3.svg' alt="img" loading='lazy' /></div>
        <div className='flex justify-center items-center row-start-3 row-end-5 col-start-1 col-end-5 gap-[35px]'>
            <div className='flex items-center justify-center'><div><img src='/pen.svg'/></div><div className={josefin1.className}>SaberAli</div></div>
            <div className='flex items-center justify-center gap-[1px]'><div><img src='/calendar.svg' loading='lazy' alt="img" /></div><div className={josefin1.className}>21 August,2020</div></div>
        </div>
