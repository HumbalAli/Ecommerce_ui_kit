...
const Latestblog = () => {
  return (
    ...
    <div className='col-start-1 col-end-6 flex justify-around items-center text-[#151875] font-bold text-[42px] leading-[49.22px] '>Latest Blog</div>

      <div className=' h-[493px] col-start-1 col-end-3 items-center grid grid-rows-5 grid-cols-5 '>
      ...
      <div className=' h-[493px] col-start-3 col-end-5 items-center grid grid-rows-5  grid-cols-5 '>
      <div className='col-start-1 col-end-6 row-start-2 row-end-2 justify-center items-center w-[370px] h-[255px]'><img src='/img2.svg'/></div>
        ...
        <div className='col-start-1 col-end-5 row-end-5 flex justify-baseline items-center font-bold text-[#FB2E86] pb-9' ><p className={josefin1.className}>Top esssential Trends in 2021</p></div>
        <div className='text-[#72718F] col-start-1 col-end-6 row-start-4 row-end-5 flex justify-around items-center w-[297px] h-[60px] pt-[70px]'><p className={lato1.className}>More off this less hello samlande lied much
        over tightly circa horse taped mightly</p></div>
      ...
      <div className=' h-[493px] col-start-5 col-end-7 items-center grid grid-rows-5 grid-cols-5 '>
