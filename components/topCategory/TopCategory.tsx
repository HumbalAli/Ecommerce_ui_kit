  ...
  return (
    <div className='h-[400px] grid grid-cols-4 grid-rows-7'>
      ...
      <div className='col-start-1 col-end-8 row-start-5 justify-between flex items-center'>
        <div><img src='/golchair1.svg' className='hover:w-[500px]'/></div>
        <div><img src='/golchair2.svg' className='hover:w-[500px]'/></div>
        <div><img src='/golchair3.svg' className='hover:w-[500px] smhidden'/></div>
        <div><img src='/golchair4.svg' className='hover:w-[500px] smhidden'/></div>
      </div>
    </div>
  )
}
